...
public class InvestigateNoiseGoal_v26_2_R1 extends Goal {
    ...
    public InvestigateNoiseGoal_v26_2_R1(Mob mob, double x, double y, double z, double speed) {
        this.mob = mob;
        this.targetX = x;
        this.targetY = y;
        this.targetZ = z;
    ...
    private void tickLingering() {
        ...
        if (lingerTicks % PLAYER_SCAN_INTERVAL == 0) {
            ...
            if (!players.isEmpty()) {
                MobSetTargetCompat_v26_2_R1.setTarget(mob, players.getFirst(),
