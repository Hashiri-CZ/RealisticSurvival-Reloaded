...
public class OwnerHurtByTargetGoal_v26_2_R1 extends TargetGoal {
    private final HLPet pet;
    private LivingEntity ownerLastHurtBy;
    private int timestamp;

    public OwnerHurtByTargetGoal_v26_2_R1(HLPet pet) {
    ...
    public void start() {
        MobSetTargetCompat_v26_2_R1.setTarget(mob, ownerLastHurtBy, EntityTargetEvent.TargetReason.TARGET_ATTACKED_OWNER);
