...
public class v26_2_R1 extends InternalsProvider {
    ...
    public void registerEntities() {
        CustomEntities_v26_2_R1.registerEntities();
    }
    ...
    public boolean assignInvestigateNoiseGoal(org.bukkit.entity.Mob mob, org.bukkit.Location target) {
        try {
            ...
            nmsMob.goalSelector.getAvailableGoals().removeIf(wrappedGoal -> {
                if (wrappedGoal.getGoal() instanceof InvestigateNoiseGoal_v26_2_R1) {
            ...
            nmsMob.goalSelector.addGoal(3,
                    new InvestigateNoiseGoal_v26_2_R1(nmsMob, target.getX(), target.getY(), target.getZ(), 1.0));
            return true;
    ...
    public void installRecipeDisplayPatcher(HLPlugin plugin, RecipeDisplayRegistry registry) {
        this.recipeDisplayPatcher = new RecipeDisplayPatcher_v26_2_R1(plugin, registry);
