...
public class OwnerHurtTargetGoal_v26_2_R1 extends TargetGoal {
    private final HLPet pet;
    private LivingEntity ownerLastHurt;
    private int timestamp;

    public OwnerHurtTargetGoal_v26_2_R1(HLPet pet) {
    ...
    public void start() {
        MobSetTargetCompat_v26_2_R1.setTarget(mob, ownerLastHurt, EntityTargetEvent.TargetReason.OWNER_ATTACKED_TARGET);
        LivingEntity owner = ((CraftPlayer) pet.getOwner()).getHandle();
        if (owner != null) {
