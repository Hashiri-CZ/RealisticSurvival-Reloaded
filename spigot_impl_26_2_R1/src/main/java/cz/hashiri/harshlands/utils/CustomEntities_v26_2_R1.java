...
public enum CustomEntities_v26_2_R1 {
    ...
    CustomEntities_v26_2_R1(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
        ...
        public static void registerEntities() {
         Map<String, Type<?>> types = getEntityTypes();
            ...
            unfreezeRegistry();
            registerEntity("fire_dragon", FireDragon_v26_2_R1::new, types);
            registerEntity("ice_dragon", IceDragon_v26_2_R1::new, types);
            registerEntity("lightning_dragon", LightningDragon_v26_2_R1::new, types);
            registerEntity("enderman_ally", EndermanAlly_v26_2_R1::new, types);
            registerEntity("sea_serpent", SeaSerpent_v26_2_R1::new, types);
            registerEntity("siren", Siren_v26_2_R1::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v26_2_R1.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v26_2_R1.FROZEN_SYMBOL);
            ...
            for (Class<?> nestedClass : MappedRegistry.class.getDeclaredClasses()) {
                if (nestedClass.getName().equals(ObfuscatedFields_v26_2_R1.TAGSET_SYMBOL_UNOBFUSCATED)) {
            ...
            Field allTags = registryClass.getDeclaredField(ObfuscatedFields_v26_2_R1.ALL_TAGS_SYMBOL);
