...
public class SeaSerpent_v26_2_R1 extends ElderGuardian implements SeaSerpent {

    private final SeaSerpentVariant variant;
    
    public SeaSerpent_v26_2_R1(EntityType<? extends ElderGuardian> entitytype, Level world) {
