...
public class EndermanAlly_v26_2_R1 extends EnderMan implements EndermanAlly {

    private final net.minecraft.world.entity.player.Player owner;

    public EndermanAlly_v26_2_R1(EntityType<? extends EnderMan> entityTypes, Level world) {
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(1, new EndermanFreezeWhenLookedAtGoal_v26_2_R1(this));
        goalSelector.addGoal(3, new FollowOwnerGoal_v26_2_R1(this, 1.0, 10.0F, 2.0F, false));
        ...
        goalSelector.addGoal(10, new EndermanLeaveBlockGoal_v26_2_R1(this));
        goalSelector.addGoal(11, new EndermanTakeBlockGoal_v26_2_R1(this));
        targetSelector.addGoal(1, new OwnerHurtByTargetGoal_v26_2_R1(this));
        targetSelector.addGoal(2, new OwnerHurtTargetGoal_v26_2_R1(this));
        targetSelector.addGoal(3, new EndermanLookForPlayerGoal_v26_2_R1(this, (entityLiving, serverLevel) -> isAngryAt(entityLiving, serverLevel)));
