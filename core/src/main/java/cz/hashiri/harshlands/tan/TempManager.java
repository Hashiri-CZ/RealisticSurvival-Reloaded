...
public class TempManager {
    ...
    public boolean isTempEnabled(@Nullable Player player) {
        return module.isTempGloballyEnabled() && HLPlayer.isValidPlayer(player) && module.isEnabled(player) && HLPlayer.getPlayers().get(player.getUniqueId()).getTanDataModule() != null;
    }
