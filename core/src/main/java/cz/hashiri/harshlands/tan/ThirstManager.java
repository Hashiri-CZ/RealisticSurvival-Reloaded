...
public class ThirstManager {
    ...
    public boolean isThirstEnabled(@Nullable Player player) {
        return module.isThirstGloballyEnabled() && HLPlayer.isValidPlayer(player) && module.isEnabled(player) && HLPlayer.getPlayers().get(player.getUniqueId()).getTanDataModule() != null;
    }
    ...
    public int getThirst(@Nullable Player player) {
        if (isThirstEnabled(player)) {
            ...
            DataModule module = HLPlayer.getPlayers().get(player.getUniqueId()).getTanDataModule();
