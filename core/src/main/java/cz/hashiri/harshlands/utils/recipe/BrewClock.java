...
public class BrewClock extends BukkitRunnable {
    ...
    private final HLBrewingRecipe recipe;
    private final ItemStack[] before;
    private final BrewingStand stand;
    private int current;

    public BrewClock(@Nonnull HLBrewingRecipe recipe, @Nonnull BrewerInventory inventory, @Nonnegative int time, @Nonnull HLPlugin plugin) {
        this.recipe = recipe;
