...
public class HLBrewingRecipe implements Recipe, HLRecipe {
    ...
    public HLBrewingRecipe(@Nonnull FileConfiguration config, @Nonnull String name, @Nonnull HLPlugin plugin) {
        this.name = name;
        ...
        this.ingredient = HLRecipe.getItem(config, name + ".Ingredient");
        this.fuel = HLRecipe.getItem(config, name + ".Fuel");
        this.potion = HLRecipe.getItem(config,name + ".Potion");
