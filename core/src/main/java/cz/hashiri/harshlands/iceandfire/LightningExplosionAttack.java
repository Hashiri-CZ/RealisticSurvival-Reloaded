...
public class LightningExplosionAttack extends ExplosionAttack {
    ...
    public LightningExplosionAttack(EnderDragon dragon, Location target, HLPlugin plugin) {
        super(dragon, target, plugin);
    }

    public LightningExplosionAttack(Dragon dragon, Location target, HLPlugin plugin) {
        super(dragon, target, plugin);
    }
