...
public class Siren_v26_1_R1 extends Guardian implements Siren {

    public Siren_v26_1_R1(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v26_1_R1(Location loc) {
