...
public class EndermanFreezeWhenLookedAtGoal_v26_1_R1 extends Goal {
    private final EnderMan enderman;
    @Nullable
    private LivingEntity target;

    public EndermanFreezeWhenLookedAtGoal_v26_1_R1(EnderMan enderman) {
    ...
    public boolean canUse() {
        ...
        if (!(target instanceof Player)) {
            ...
            return !(d0 > 256.0) && v26_1_R1.isLookingAtMe(enderman, (Player) target);
        }
    }
