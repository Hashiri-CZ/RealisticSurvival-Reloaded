...
import cz.hashiri.harshlands.iceandfire.SeaSerpent;
...
public class SeaSerpent_v26_1_R1 extends ElderGuardian implements SeaSerpent {

    private final SeaSerpentVariant variant;
    
    public SeaSerpent_v26_1_R1(EntityType<? extends ElderGuardian> entitytype, Level world) {
    ...
    public SeaSerpent_v26_1_R1(Location loc) {
    ...
    public SeaSerpent_v26_1_R1(Location loc, SeaSerpentVariant variant) {
        super(EntityType.ELDER_GUARDIAN, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPos(loc.getX(), loc.getY(), loc.getZ());
