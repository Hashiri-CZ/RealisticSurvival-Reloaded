...
public enum CustomEntities_v26_1_R1 {

    ENDERMAN_ALLY("enderman_ally", -1, EntityType.ENDERMAN, EnderMan.class, EndermanAlly_v26_1_R1.class),
    FIRE_DRAGON("fire_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, FireDragon_v26_1_R1.class),
    ICE_DRAGON("ice_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, IceDragon_v26_1_R1.class),
    LIGHTNING_DRAGON("lightning_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, LightningDragon_v26_1_R1.class),
    SEA_SERPENT("sea_serpent", -1, EntityType.ELDER_GUARDIAN, ElderGuardian.class, SeaSerpent_v26_1_R1.class),
    SIREN("siren", -1, EntityType.GUARDIAN, Guardian.class, Siren_v26_1_R1.class);
    ...
    CustomEntities_v26_1_R1(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
        ...
        public static void registerEntities() {
         Map<String, Type<?>> types = getEntityTypes();
            ...
            unfreezeRegistry();
            registerEntity("fire_dragon", FireDragon_v26_1_R1::new, types);
            registerEntity("ice_dragon", IceDragon_v26_1_R1::new, types);
            registerEntity("lightning_dragon", LightningDragon_v26_1_R1::new, types);
            registerEntity("enderman_ally", EndermanAlly_v26_1_R1::new, types);
            registerEntity("sea_serpent", SeaSerpent_v26_1_R1::new, types);
            registerEntity("siren", Siren_v26_1_R1::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R1.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R1.FROZEN_SYMBOL);
            ...
            Field allTags = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R1.ALL_TAGS_SYMBOL);
