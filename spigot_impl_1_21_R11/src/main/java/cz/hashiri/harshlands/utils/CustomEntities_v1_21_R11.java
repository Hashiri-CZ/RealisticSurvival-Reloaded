...
public enum CustomEntities_v1_21_R11 {

    ENDERMAN_ALLY("enderman_ally", -1, EntityType.ENDERMAN, EnderMan.class, EndermanAlly_v1_21_R11.class),
    FIRE_DRAGON("fire_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, FireDragon_v1_21_R11.class),
    ICE_DRAGON("ice_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, IceDragon_v1_21_R11.class),
    LIGHTNING_DRAGON("lightning_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, LightningDragon_v1_21_R11.class),
    SEA_SERPENT("sea_serpent", -1, EntityType.ELDER_GUARDIAN, ElderGuardian.class, SeaSerpent_v1_21_R11.class),
    SIREN("siren", -1, EntityType.GUARDIAN, Guardian.class, Siren_v1_21_R11.class);
    ...
    CustomEntities_v1_21_R11(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
        ...
        public static void registerEntities() {
         Map<String, Type<?>> types = getEntityTypes();
            ...
            registerEntity("ice_dragon", IceDragon_v1_21_R11::new, types);
            registerEntity("lightning_dragon", LightningDragon_v1_21_R11::new, types);
            registerEntity("enderman_ally", EndermanAlly_v1_21_R11::new, types);
            registerEntity("sea_serpent", SeaSerpent_v1_21_R11::new, types);
            registerEntity("siren", Siren_v1_21_R11::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R11.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R11.FROZEN_SYMBOL);
            ...
            for (Class<?> nestedClass : MappedRegistry.class.getDeclaredClasses()) {
                if (nestedClass.getName().equals(ObfuscatedFields_v1_21_R11.TAGSET_SYMBOL_OBFUSCATED) || nestedClass.getName().equals(ObfuscatedFields_v1_21_R11.TAGSET_SYMBOL_UNOBFUSCATED)) {
            ...
            Field allTags = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R11.ALL_TAGS_SYMBOL);
